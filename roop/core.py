...
def parse_args() -> None:
    ...
    program.add_argument('--enable-nsfw-check', help='enable NSFW content filtering', dest='enable_nsfw_check', action='store_true')
    ...
    roop.globals.enable_nsfw_check = args.enable_nsfw_check
...
def start() -> None:
    ...
    if has_image_extension(roop.globals.target_path):
        if roop.globals.enable_nsfw_check and predict_image(roop.globals.target_path):
            destroy()
    ...
    if roop.globals.enable_nsfw_check and predict_video(roop.globals.target_path):
        destroy()
